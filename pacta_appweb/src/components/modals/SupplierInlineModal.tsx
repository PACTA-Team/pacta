...
export function SupplierInlineModal({ companyId, open, onOpenChange, onSuccess }: SupplierInlineModalProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Crear un nuevo proveedor para este contrato.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {documentUrl ? (
              ...
              <div className="border-2 border-dashed rounded-lg p-4 text-center">
                <Input
                  ...
                  disabled={uploading}
                  className="hidden"
                  id="supplier-document-upload"
                />
                <Label htmlFor="supplier-document-upload" className="cursor-pointer">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={loading}>
              {loading ? tCommon('saving') : t('createSupplier')}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
